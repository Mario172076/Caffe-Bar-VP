...
За базата на податоци испраќаме соодветни скрипти за полнење на базата, како и еден backup фајл.
...
![Слика 9](https://github.com/Mario172076/Caffe-Bar-VP-/blob/main/CaffeBar/CaffeBar/bin/img/OrderHistoryForm.png?raw=true "Слика 9: Форма за детален преглед на испорачаните нарачки")
